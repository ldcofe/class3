...
module GlobalData {
	...
	export var isVerticalGame:boolean = true;		

	// 配置文件
	export var config_json:any;

	// 单词卡弹出层出现次数
	export var xuanXiangKaNum:number;

	export var dancikaTimerClear:any;

	export var bgSounds:any;
